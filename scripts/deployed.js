const contracts = { 
    icplazaTest: {
        ...
        MerlinSwapFactory: '0xC6C7c2edF70A3245ad6051E93809162B9758ce08',
    ...
    icplaza: {
        ...
        MerlinSwapFactory: '0xCe1E9F846b05Ce9996BA2f55F3EC731c7C1A0fdb',
	liquidityManager: '0x5bD3E57915D8136d5118Fb08C838542A3DE817DC',
	swap: '0xE0c7b10009fC582beFE3cAFE777eC7E2753368aF',
    },
    scrollSepoliaTest: {
        MerlinSwapFactory: '0x64c2F1306b4ED3183E7B345158fd01c19C0d8c5E',
    },
    scroll: {
        MerlinSwapFactory: '0x8c7d3063579BdB0b90997e18A770eaE32E1eBb08',
    },
    bedrockRolluxTestL2: {
        MerlinSwapFactory: '0x64c2F1306b4ED3183E7B345158fd01c19C0d8c5E',
    ...
    mantleTest: {
        MerlinSwapFactory: '0xF7713d221418e098a788C4DaDd52F74b55B379E5',
    ...
    mantle: {
	MerlinSwapFactory: '0x45e5F26451CDB01B0fA1f8582E0aAD9A6F27C218',
    ...
    bscTest: {
        MerlinSwapFactory: '0x7fc0574eAe768B109EF38BC32665e6421c52Ee9d',
    ...
    ontologyTest: {
        MerlinSwapFactory: '0x7336A5a3251b9259DDf8B9D02a96dA0153e0799d',
    },
    bsc: {
        MerlinSwapFactory: '0x93BB94a0d5269cb437A1F71FF3a77AB753844422',
    ...
    ontology: {
	MerlinSwapFactory: '0x032b241De86a8660f1Ae0691a4760B426EA246d7',
    },
    ethereum: {
        wrapChainToken: '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2',
        MerlinSwapFactory: '0x1502d025BfA624469892289D45C0352997251728',
        liquidityManager: '0x19b683A2F45012318d9B2aE1280d68d3eC54D663',
        swap: '0x2db0AFD0045F3518c77eC6591a542e326Befd3D7',
    },
    aurora: {
        MerlinSwapFactory: '0xce326A82913EAb09f7ec899C4508Cbe0E6526A74',
    ...
    confluxEspace: {
        MerlinSwapFactory: '0x77aB297Da4f3667059ef0C32F5bc657f1006cBB0',
    ...
    arbitrum: {
        MerlinSwapFactory: '0xCFD8A067e1fa03474e79Be646c5f6b6A27847399',
    ...
    cronos: {
        MerlinSwapFactory: '0x3EF68D3f7664b2805D4E88381b64868a56f88bC4',
    ...
    etc: {
        MerlinSwapFactory: '0x79D175eF5fBe31b5D84B3ee359fcbBB466153E39',
        wrapChainToken: '0x1953cab0E5bFa6D4a9BaD6E05fD46C1CC6527a5a',
    },
    polygon: {
        MerlinSwapFactory: '0xcA7e21764CD8f7c1Ec40e651E25Da68AeD096037',
        wrapChainToken: '0x0d500b1d8e8ef31e21c99d1db9a6444d3adf1270',
    },
    meter: {
        MerlinSwapFactory: '0xed31C5a9C764761C3A699E2732183ba5d6EAcC35',
        wrapChainToken: '0x160361ce13ec33C993b5cCA8f62B6864943eb083',
    },
    telos: {
        MerlinSwapFactory: '0x6a7CDD0CC87ec02ed85c196e57BaBe1bc0Acd6f2',
        wrapChainToken: '0xD102cE6A4dB07D247fcc28F366A623Df0938CA9E',
    },
    ultron: {
        MerlinSwapFactory: '0xd7de110Bd452AAB96608ac3750c3730A17993DE0',
    ...
    opsideTestRollux: {
	MerlinSwapFactory: '0x58ce24c6cDC0d5A2c3BcA1e179E869AF97266829',
	wrapChainToken: '0x67A1f4A939b477A6b7c5BF94D97E45dE87E608eF',
